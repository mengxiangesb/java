...
public class QRScanController {
    ...
    /**
     * 手机扫码后会显示一个连接，如：http://192.168.3.222:8099/scanLogin?uuid=c4a4ef20-ad21-49ba-8665-55830053de3d  接着就可以点击访问该链接，并传递uuid，如果该uuid与刚才生成的一致就可以正常登录了
     * @param uuid
     * @return
     */
    @RequestMapping("/scanLogin")
    @ResponseBody
    public JSONObject scanLogin(String uuid,HttpServletRequest request){
